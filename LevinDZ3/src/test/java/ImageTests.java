...
public class ImageTests extends BaseTest {
    ...
    void uploadFileImageTest() {
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", new File("src/test/resources/redcar.jpg"))
                .expect()
                .statusCode(200)
                .when()
                .post("https://api.imgur.com/3/image")
    ...
    void uploadFileUrlTest() {
        uploadedImageId = given()
                .headers("Authorization", token)
                .multiPart("image", new String ("https://media.istockphoto.com/photos/pint-of-guinness-picture-id458593013"))
                .expect()
                .statusCode(200)
                .when()
                .post("https://api.imgur.com/3/image")
