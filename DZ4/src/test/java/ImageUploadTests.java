...
public class ImageUploadTests extends BaseTest {
    ...
    private final String PATH_TO_IMAGE = "src/test/resources/redcar.jpg";
    ...
    @Test
    void uploadFileTest() {
        uploadedImageId = given(requestWithAuth)
    ...
    void uploadFileImageTest() {
        uploadedImageId =   given(requestWithAuthAndImage, positiveResponseSpecification)
    ...
    void uploadFileUrlTest() {
        uploadedImageId =   given(requestWithAuthAndURLImage, positiveResponseSpecification)
    ...
    void uploadFileVideoTest() {
        uploadedImageId = given(requestWithAuth)
                .multiPart("video", new File("src/test/resources/video.mp4"))
                .expect()
                .statusCode(200)
                .when()
                .post("/image")
